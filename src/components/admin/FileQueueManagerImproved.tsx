...
import { Play, RotateCcw, Trash2, ChevronDown, Loader2, FileText, CheckCircle2, XCircle, Clock } from "lucide-react";
import { useToast } from "@/hooks/use-toast";
import { Switch } from "@/components/ui/switch";
import { Label } from "@/components/ui/label";

const FileQueueManagerImproved = () => {
  ...
  const processQueue = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Bearbetning av nedladdningskön har startat",
      });
      
      refetch();
    } catch (error: any) {
      toast({
        title: "Fel vid start av filnedladdning",
      ...
      <CardHeader>
        <CardTitle className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <Label htmlFor="auto-process" className="text-sm">Auto</Label>
          </div>
        </CardTitle>
      </CardHeader>
      <CardContent>
...
export default FileQueueManagerImproved;
